      ...
      <div style={{ padding: isPC ? "14px 0" : 14 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 14, padding: 16, boxShadow: "0 2px 8px rgba(0,0,0,0.07)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {QUICK_LINKS.map(l => (
              <a key={l.label} href={l.url} target="_blank" rel="noopener noreferrer" style={{ background: `${l.color}15`, border: `1.5px solid ${l.color}40`, borderRadius: 12, padding: "14px 12px", textDecoration: "none", display: "block" }}>
